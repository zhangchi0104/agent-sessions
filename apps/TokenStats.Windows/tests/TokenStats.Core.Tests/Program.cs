...
internal static class Program
{
    ...
    public static async Task<int> Main()
    {
        var tests = new TestCase[]
        {
            ...
            new(
                nameof(CursorTests.UsageParserReadsOfficialModelBucketsAtomically),
                Sync(CursorTests.UsageParserReadsOfficialModelBucketsAtomically)),
            new(
                nameof(CursorTests.RegistryKeepsCursorOutOfTranscriptRoots),
                Sync(CursorTests.RegistryKeepsCursorOutOfTranscriptRoots)),
            ...
            new(
                nameof(CursorTests.OAuthBuildsLoginAndRotatesTokens),
                Sync(CursorTests.OAuthBuildsLoginAndRotatesTokens)),
            new(
                nameof(CursorTests.OAuthPollingUsesAnAbsoluteDeadline),
                CursorTests.OAuthPollingUsesAnAbsoluteDeadline),
            new(
                nameof(CursorTests.UsageProviderSendsHeadersAndRejectsPartialWindows),
                CursorTests.UsageProviderSendsHeadersAndRejectsPartialWindows),
