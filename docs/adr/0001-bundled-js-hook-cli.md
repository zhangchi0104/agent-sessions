...
Status: Superseded by [TokenStats ADR-0005](../../apps/TokenStats/docs/adr/0005-tokenstats-tracks-usage-only.md)

> Kept as a record of a decision that was made and then unmade. The hook CLI,
> the plugins, and the shared database this describes were all deleted when
> TokenStats became usage-only; nothing below still exists in the repository.
